						...
						<div class="streamline m-l-lg">
							<div class="sl-item p-b-md">
								<div class="sl-avatar avatar avatar-sm avatar-circle">
									{{ Html::image('/assets/backend/images/221.jpg', 'avatar', array('class' => 'img-responsive')) }}
								</div><!-- .avatar -->
							...
							<div class="sl-item p-b-md">
								<div class="sl-avatar avatar avatar-sm avatar-circle">
										{{ Html::image('/assets/backend/images/214.jpg', 'avatar', array('class' => 'img-responsive')) }}
								</div><!-- .avatar -->
								<div class="sl-content m-l-xl">
							...
							<div class="sl-item p-b-md">
								<div class="sl-avatar avatar avatar-sm avatar-circle">
										{{ Html::image('/assets/backend/images/217.jpg', 'avatar', array('class' => 'img-responsive')) }}
								</div><!-- .avatar -->
								<div class="sl-content m-l-xl">
							...
							<div class="sl-item p-b-md">
								<div class="sl-avatar avatar avatar-sm avatar-circle">
										{{ Html::image('/assets/backend/images/211.jpg', 'avatar', array('class' => 'img-responsive')) }}
								</div><!-- .avatar -->
								<div class="sl-content m-l-xl">
