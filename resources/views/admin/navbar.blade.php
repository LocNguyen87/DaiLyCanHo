				...
				<div class="media-group dropdown-menu animated flipInY">
						...
						<div class="media">
							<div class="media-left">
								<div class="avatar avatar-xs avatar-circle">
									{{ Html::image('/assets/backend/images/221.jpg', '') }}
					...
					<a href="javascript:void(0)" class="media-group-item">
						<div class="media">
							<div class="media-left">
								<div class="avatar avatar-xs avatar-circle">
									{{ Html::image('/assets/backend/images/205.jpg', '') }}
					...
					<a href="javascript:void(0)" class="media-group-item">
						<div class="media">
							<div class="media-left">
								<div class="avatar avatar-xs avatar-circle">
									{{ Html::image('/assets/backend/images/207.jpg', '') }}
					...
					<a href="javascript:void(0)" class="media-group-item">
						<div class="media">
							<div class="media-left">
								<div class="avatar avatar-xs avatar-circle">
									{{ Html::image('/assets/backend/images/211.jpg', '') }}
									<i class="status status-away"></i>
								</div>
							</div>
							<div class="media-body">
						...
						<div class="media-group">
							...
							<a href="javascript:void(0)" class="media-group-item">
								<div class="media">
									<div class="media-left">
										<div class="avatar avatar-xs avatar-circle">
											{{ Html::image('/assets/backend/images/206.jpg', '') }}
											<i class="status status-online"></i>
										</div>
									</div>
									<div class="media-body">
							...
							<a href="javascript:void(0)" class="media-group-item">
								<div class="media">
									<div class="media-left">
										<div class="avatar avatar-xs avatar-circle">
											{{ Html::image('/assets/backend/images/208.jpg', '') }}
											<i class="status status-away"></i>
										</div>
									</div>
									<div class="media-body">
							...
							<a href="javascript:void(0)" class="media-group-item">
								<div class="media">
									<div class="media-left">
										<div class="avatar avatar-xs avatar-circle">
											{{ Html::image('/assets/backend/images/209.jpg', '') }}
											<i class="status status-away"></i>
										</div>
									</div>
									<div class="media-body">
							...
							<a href="javascript:void(0)" class="media-group-item">
								<div class="media">
									<div class="media-left">
										<div class="avatar avatar-xs avatar-circle">
											{{ Html::image('/assets/backend/images/219.jpg', '') }}
											<i class="status status-away"></i>
										</div>
									</div>
									<div class="media-body">
							...
							<a href="javascript:void(0)" class="media-group-item">
								<div class="media">
									<div class="media-left">
										<div class="avatar avatar-xs avatar-circle">
											{{ Html::image('/assets/backend/images/210.jpg', '') }}
											<i class="status status-offline"></i>
										</div>
									</div>
									<div class="media-body">
							...
							<a href="javascript:void(0)" class="media-group-item">
								<div class="media">
									<div class="media-left">
										<div class="avatar avatar-xs avatar-circle">
											{{ Html::image('/assets/backend/images/212.jpg', '') }}
											<i class="status status-offline"></i>
										</div>
									</div>
									<div class="media-body">
